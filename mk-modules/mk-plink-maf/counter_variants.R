...
# args[1] <- "test/data/sampleWGS.maf.plink.tsv" ## variants in original file
# args[2] <- "test/results/sampleWGS.maf.plink.bed" ## stem for output

## Passing args to named objects
variants_tsv <- args[1]
stem <- args[2]
output_file <- gsub(pattern = ".bed", replacement = ".svg", x = stem)
